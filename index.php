...
<body>
	...
	<div class="container">
	<img src="upload_images/logo.png" alt="" width="250px" ><br><br>
  ...
  <hr>	
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">N.R</th>
				<th class="text-center" scope="col">Name</th>
				<th class="text-center" scope="col">Student Id.</th>
				<th class="text-center" scope="col">Phone</th>
				<th class="text-center" scope="col">Email</th>
				<th class="text-center" scope="col">University Profile</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="upload_images/logo.png" width="300px" height="120px" alt=""></center>
...
<input type="phone" class="form-control" name="user_phone" placeholder="Enter Phone Number." maxlength="10" required>
</div>
</div>
...
<div class="form-group col-md-6">
<label for="universitydegree">University Profile</label>
<input type="text" class="form-control" name="user_degree" placeholder="Enter University Profile">
</div>
</div>
...
<div class="form-group col-md-6">
<label for="passaportid">Passaport ID</label>
<input type="text" class="form-control" name="passaport" maxlength="12" placeholder="Enter passaport number ">
</div>
</div>
...
<input type="text" class="form-control" name="pstation" placeholder="Enter police station">
</div>
<div class="form-row">
<div class="form-group col-md-6">
...
<select name="state" class="form-control">
  ...
  <option value="Kosove">Kosove</option>
		...
		<option value='Malizi'>Mali i zi</option>
...
while($row = mysqli_fetch_array($run_data))
{
	...
	$gender = $row['u_gender'];
	$email = $row['u_email'];
	$passaport = $row['u_passaport'];
	$Bday = $row['u_birthday'];
	$family = $row['u_family'];
	$phone = $row['u_phone'];
	$address = $row['u_state'];
	$village = $row['u_village'];
	$pstation = $row['u_pstation'];
	$dist = $row['u_dist'];
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<strong>Father Name :</strong> $father <br>
						<strong>Universitety profile :</strong>$degree <br>
						<strong>passaport :</strong> $passaport <br>
						...
						<i class='fa fa-home' aria-hidden='true'> Address : </i> $village, $pstation, <br> $dist, $state - $pincode
						<br />
						</p>
						<!-- Split button -->
					</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='universitydegree'>University Profile</label>
		<input type='text' class='form-control' name='user_degree' placeholder='Enter Your University Profile' value='$degree'>
		</div>
		</div>
		...
		<div class='form-group col-md-6'>
		<label for='passaportid'>passaport ID</label>
		<input type='text' class='form-control' name='user_passaport' maxlength='12' placeholder='Enter your passaport number ' value='$passaport'>
		</div>
		</div>
		...
		<div class='form-group'>
		<label for='inputAddress2'>Police station</label>
		<input type='text' class='form-control' name='police' placeholder='Enter ' value='$pstation'>
		</div>
		<div class='form-row'>
		<div class='form-group col-md-6'>
		<label for='inputCity'>District</label>
